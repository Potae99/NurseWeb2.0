...
import Admin_student_edit from './Admin_student_edit';
...
function Home_admin_studentDetail() {
    ...
    return (
        <div>
            <Routes>
                <Route path='/admin/student/edit/:userID' element={<Admin_student_edit />} />
            </Routes>
...
export default Home_admin_studentDetail