                ...
                <div className=' bg-white slate-500 min-h-screen '>
                    ...
                    <div className='  grid grid-cols-2 '>
                        ...
                        <div className=' absolute right-0 mr-7 '>
                            <button onClick={addAdmin} className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-black transition duration-300 ease-out border-2 border-orange-300 rounded-full shadow-md group" type="submit" value="submit">
                                <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-orange-300 group-hover:translate-x-0 ease">
