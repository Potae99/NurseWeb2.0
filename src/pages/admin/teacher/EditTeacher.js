...
function EditTeacher() {
    ...
    return (
        <div>
            ...
            <div className=' bg-white slate-500 min-h-screen border'>
                ...
                <div className='  grid grid-cols-2 '>
                    <div className=' ml-3'>
                        <button onClick={() => backToTeacherDetail(userID)} className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-black transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
                    ...
                    <div className=' absolute right-0 mr-7'>
                        <button onClick={() => editTeacher(userID)} className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-black transition duration-300 ease-out border-2 border-purple-500 rounded-full shadow-md group">
                            <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-orange-300 group-hover:translate-x-0 ease">
