        ...
        <div className=' bg-white slate-500 min-h-screen '>
            ...
            <div className='container mx-auto text-black'>
                <div className=' grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-2 p-6 '>
                    ...
                    <div>
                            <label>
                                เพศ
                                <select value={gender} onChange={(event => {setgender(event.target.value)})} name='เพศ' className="w-full rounded-md border border-while  bg-gray-100 py-3 px-6 text-base font-medium text-black outline-none focus:border-black focus:shadow-md"
                                required>
            ...
            <div className='  grid grid-cols-2 '>
                ...
                <div className=' absolute right-0 mr-7'>
                    <button onClick={addStudent} type="submit" className="relative inline-flex items-center justify-center p-4 px-6 py-3 overflow-hidden font-medium text-black transition duration-300 ease-out border-2 border-orange-300 rounded-full shadow-md group">
                        <span className="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 -translate-x-full bg-orange-300 group-hover:translate-x-0 ease">
